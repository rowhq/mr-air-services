...
const actionItems = [
  ...
  // NEW - Service pricing that we invented
  {
    ...
    status: 'needs-verification',
    priority: 'critical',
    question: 'We show the CoolSaver tune-up as FREE for qualifying homeowners. Is this correct? Your website mentions this but doesn\'t specify qualification requirements.',
    currentData: [
      'CoolSaver AC Tune-Up: FREE (for qualifying homeowners)',
      'Heater Tune-Ups: Also offered (pricing not shown)',
    ],
  },
];
