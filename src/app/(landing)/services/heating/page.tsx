    ...
    <>
      ...
      <section id="tune-up" className="py-20 lg:py-28 bg-neutral-50 dark:bg-neutral-800 scroll-mt-20">
        <div className="container">
          ...
          {/* Safety Callout */}
          <div className="max-w-3xl mx-auto bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-2xl p-6 md:p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-red-800 dark:text-red-300 mb-2">Carbon Monoxide: The Silent Killer</h3>
