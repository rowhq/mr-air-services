        ...
        <div className="container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            {[
              ...
              <div
                key={service.name}
                className="group p-5 bg-neutral-50 dark:bg-neutral-800 rounded-2xl hover:bg-primary/5 dark:hover:bg-primary/10 transition-all duration-300"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {plans.map((plan) => {
              ...
              return (
                <div
                  key={plan.name}
                  className={`relative flex flex-col rounded-2xl p-6 bg-white dark:bg-neutral-900 transition-all duration-300 ${
                    isPremium ? 'bg-primary/5 dark:bg-primary/10' : ''
                  }`}
                >
                  {isPremium && (
                    ...
                    {plan.features.map((feature) => (
                      <li key={feature.text} className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          {feature.value && (
                            <span className="block text-xs text-primary">{feature.value}</span>
                          )}
                        </div>
                      </li>
                    ))}
                  ...
                  <div className="mt-6 pt-4 border-t border-neutral-200 dark:border-neutral-700">
                    <p className="flex items-center gap-1.5 text-xs text-green-600 dark:text-green-400 mb-4">
                    ...
                    <Link href="/contact">
                      <Button variant={isPremium ? 'primary' : 'outline'} fullWidth>
                        {plan.price === 'Custom' ? 'Get Quote' : `Choose ${plan.name}`}
                      </Button>
                    </Link>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit, index) => {
              ...
              return (
                <div
                  key={benefit.title}
                  className="benefit-card bg-neutral-50 dark:bg-neutral-800 p-8 rounded-2xl transition-all duration-300 group"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((testimonial, index) => (
              <div
                ...
                className="testimonial-card bg-white dark:bg-neutral-900 p-8 rounded-2xl transition-all duration-300"
                style={{ animationDelay: `${index * 100}ms` }}
              >
                {/* Stars */}
