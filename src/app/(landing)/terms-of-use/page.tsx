        ...
        <div className="container">
          <div className="max-w-3xl mx-auto prose prose-lg prose-neutral">
            <div className="bg-neutral-50 dark:bg-neutral-800 rounded-2xl p-8 mb-10">
              <h2 className="text-2xl font-bold text-neutral-black dark:text-white mb-4 mt-0">Agreement to Terms</h2>
            ...
            <h2 className="text-2xl font-bold text-neutral-black dark:text-white mb-4">Use of Website</h2>
            ...
            <ul className="list-none pl-0 space-y-3 mb-6">
              {[
                ...
                <li key={item} className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-neutral-200 dark:bg-neutral-700 flex items-center justify-center flex-shrink-0 mt-0.5">
            ...
            <h2 className="text-2xl font-bold text-neutral-black dark:text-white mb-4 mt-10">Service Appointments</h2>
            ...
            <h2 className="text-2xl font-bold text-neutral-black dark:text-white mb-4 mt-10">Pricing and Payment</h2>
            <p className="text-neutral-600 dark:text-neutral-400 mb-6 leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-neutral-black dark:text-white mb-4 mt-10">Warranties and Guarantees</h2>
            <p className="text-neutral-600 dark:text-neutral-400 mb-6 leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-neutral-black dark:text-white mb-4 mt-10">Intellectual Property</h2>
            <p className="text-neutral-600 dark:text-neutral-400 mb-6 leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-neutral-black dark:text-white mb-4 mt-10">Limitation of Liability</h2>
            <p className="text-neutral-600 dark:text-neutral-400 mb-6 leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-neutral-black dark:text-white mb-4 mt-10">Governing Law</h2>
            <p className="text-neutral-600 dark:text-neutral-400 mb-6 leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-neutral-black dark:text-white mb-4 mt-10">Changes to Terms</h2>
            <p className="text-neutral-600 dark:text-neutral-400 mb-6 leading-relaxed">
            ...
            <div className="bg-neutral-50 dark:bg-neutral-800 rounded-2xl p-8 mt-10">
              <h2 className="text-2xl font-bold text-neutral-black dark:text-white mb-4 mt-0">Contact</h2>
              <p className="text-neutral-600 dark:text-neutral-400 mb-4 leading-relaxed">
