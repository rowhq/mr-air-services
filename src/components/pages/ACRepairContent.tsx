...
export interface ACRepairPageConfig {
  hero: {
    title: string;
    description: string;
...
export const defaultACRepairConfig: ACRepairPageConfig = {
  hero: {
...
export function ACRepairContent({ config, faqs, isPreview = false }: ACRepairContentProps) {
  ...
  return (
    <>
      ...
      {/* Hero */}
      <section className={`relative min-h-[500px] md:min-h-[600px] lg:min-h-[670px] pt-32 overflow-hidden ${isPreview ? 'mt-8' : ''}`}>
        {/* Background Image */}
        <div
