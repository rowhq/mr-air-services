...
export const defaultServicesConfig: ServicesPageConfig = {
  hero: {
    title: 'HVAC Services',
...
export function ServicesContent({ config, isPreview = false }: ServicesContentProps) {
  return (
    <>
      {/* Preview indicator */}
      {isPreview && (
      ...
      <section className={`relative min-h-[50vh] pt-32 bg-gradient-to-b from-neutral-900 to-neutral-800 overflow-hidden ${isPreview ? 'mt-8' : ''}`}>
