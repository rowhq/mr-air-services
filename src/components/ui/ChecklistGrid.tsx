...
// Icons for different inspection items
...
// Default check icon for items without specific icons
const defaultIcon = (
  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {visibleItems.map((item, index) => (
          ...
          >
            ...
            <span className="text-neutral-700 dark:text-neutral-300 font-medium text-sm group-hover:text-primary dark:group-hover:text-primary-light transition-colors">
              {item}
            </span>
          </div>
        ))}
